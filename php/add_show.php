        ...
        <p class="display-6">Add Show</p>
         <form method="POST" class="form">
            ...
            <!-- <label for="name">Name</label>
             ...
             <select name="movie" class="form-control my-3">
             <option disabled selected hidden>Select Movie</option>
                <?php 
            ...
            <select name="theatre" class="form-control my-3">
            <option disabled selected hidden>Select Theatre</option>
                    <?php 
            ...
            <select name="time" class="form-control my-3">
